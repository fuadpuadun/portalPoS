...
<html>
    ...
    <body>
        <!-- Navbar -->
        <nav class="navbar navbar-expand-lg navbar-dark bg-secondary fixed-top shadow" style="background-color: #2D58C7 !important;">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href= "<?php echo base_url(''); ?>">Stock Opname</a>
                    </li>
                    <li class="nav-item">
