...
<body>
    <div class="login-form">
        <form action="<?= base_url('signin/send') ?>" method="post">
            ...
            <div class="form-group">
                <button name='submit' type="submit" class="btn btn-block">Masuk</button>
            </div>
            <div class="clearfix">
                <p class="text-center">Belum punya akun? <a href="<?= base_url('signup') ?>">buat akun</a> sekarang</p>
            </div>
        </form>
    </div>
</body>
